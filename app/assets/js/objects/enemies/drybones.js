...
class DryBones extends Enemy {
	constructor(data) {
		super(data);

		this.scene = this.data.scene;
		this.spriteOffset = this.scene.spriteSheetData.enemies.dry_bones.default;

		if ((this.data.flags & 0b100) == 0b100) {
			this.spriteOffset = this.scene.spriteSheetData.enemies.dry_bones.shell;
		}
	}
